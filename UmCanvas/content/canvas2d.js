var canvas2d_contexts = {};

function canvas2d_getContext(d) {
    var id = Blazor.platform.readStringField(d, 0);
    var dc = canvas2d_contexts[id];
    if (dc)
        return dc;
    var c = document.getElementById(id);
    dc = c.getContext("2d");
    canvas2d_contexts[id] = dc;
    return dc;
}
